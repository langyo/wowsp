  ...
  setup(props) {
    ...
    function updateMarkersAt(t: number) {
      ...
      for (let i = 0; i < shipMarkers.length; i++) {
        ...
        // current (possibly still-moving) position + a live "gone for N s"
        // counter. Use the LIVE time, not the death instant, so sinking ships
        // that keep drifting keep their box + floating label in sync.
