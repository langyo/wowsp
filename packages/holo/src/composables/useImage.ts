 ...
 *
 * Written as an upstream candidate for @celestia-island/hikari's
 * composable set (string-union status ref, flat return object,
 * MaybeRefOrGetter source) — keep it Vue-only.
 */
