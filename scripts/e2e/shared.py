"""Shared constants for WoWSP e2e tests.

Self-contained (no package-relative import) so tests can `from shared import ...`
when pytest runs with `pythonpath = .` pointing at scripts/e2e/.
"""
